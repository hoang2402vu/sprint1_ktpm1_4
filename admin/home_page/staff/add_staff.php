...
<body>
    ...
    <div class="login">
      <div class="login-header">
        <h4 class="header_title">THÊM NHÂN VIÊN</h4>
      </div>
      <form class="login-form" method = "post" action = 'add_staff_process.php'>
      ...
      <input type="hidden" name="id" value="<?php echo $id ?>">
        ...
        <div class="wrap_input">
            ...
            <div class="gender_choose">
                <div class="gender">
                    <input type="radio" value="nam"  name="gender" checked = "checked"/><span>nam</span>
                </div>

                <div class="gender">
                    <input type="radio" value="nữ"  name="gender" /><span>nữ</span>
                </div>
            </div>
